...
The project will allow me to consolidate and practically apply HTML/CSS concepts:

1. HTML5.
2. Advanced CSS Layouts (Flexbox).
3. Box Model.
4. Working with Git and a GitHub repository.
5. Clean, readable CSS code with a logical structure.
---

Technologies Used

1. HTML5 (Semantic structure)
2. CSS3 (Flexbox, Box Model)
3. Git & GitHub
4. Working on Ubuntu.
---
...
Projekt pozwoli mi utrwalić i zastosować w praktyce kluczowe zagadnienia z zakresu HTML/CSS:

1. HTML5.
2. Zaawansowane układy CSS (Flexbox).
3. Box Model.
4. Praca z Git i repozytorium Github.
5. W miarę czysty, czytelny kod CSS z zachowaniem logicznej struktury.
---

Użyte technologie

1. HTML5 (Semantyczna struktura)
2. CSS3 (Flexbox, Box Model)
3. Git & GitHub
4. Praca na Ubuntu.
---
